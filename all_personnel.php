                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class = "panel panel-primary">
                            <div class = "panel-heading" style="background-color:#556B2F;">
                                <h4>ALL DEPARTMENT - PERSONNELS</h4>
                                <a href="add_personnel.php">
                                    <input type="button" value="Add Personnel" class="btn btn-block btn-success" style="margin-top: -30px; margin-left:730px; width: auto; position:absolute;">
                                </a>
                                <a href="print_all_campus.php">
                                <input type="button" value="Print" class="btn btn-block btn-success" style="margin-top: -30px; margin-left:870px; width: auto; position:absolute;">
                                </a>
                            </div>
                        </div>
                        <div id="print">
