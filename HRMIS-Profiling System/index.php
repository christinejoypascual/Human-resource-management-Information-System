...
<html lang = "eng">
	<head>
		<title>AFP PERSONNEL PROFILE</title>
		<meta charset = "utf-8" />
...
<body>
	<div class = "navbar navbar-default" style="background-color:#556B2F;">
		<img src = "" style = "float:left;" height = "55px" /><span class = "navbar-brand">AFP HUMAN RESOURCE MANGEMENT SYSTEM</span>
	</div>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Copyright AFP PERSONNEL PROFILING 2020</label>
	</div>
</body>
<?php
	include("script.php");
