...
<body class="theme-red">
    ...
    <!-- Top Bar -->
    <nav class="navbar">
        <div class="container-fluid" style="background-color:#556B2F;">
            <div class="navbar-header">
                <a href="javascript:void(0);" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" aria-expanded="false"></a>
                <a href="javascript:void(0);" class="bars"></a>
                <a class="navbar-brand" href="home.php" style="color: #fff;">HUMAN RESOURSE MANAGEMENT SYSTEM</a>
                ...
                <ul class="list">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <i class="glyphicon glyphicon-education"></i>&nbsp;&nbsp;Department
                        </a>
                        <ul class="ml-menu">
                            <li>
                                <a href="all_campus.php">ALL DEPARTMENT</a>
                            </li>
                            <li>
                                <a href="talisay_campus.php">ARMY</a>
                            </li>
                            <li>
                                <a href="fortune_towne_campus.php">NAVY</a>
                            </li>
                            <li>
                                <a href="alijis_campus.php">MARINES</a>
                            </li>
                            <li>
                                <a href="binalbagan_campus.php">AIR FORCE</a>
                            </li>
                        </ul>
                    </li>
                    <li>
